...
core = GBuilder.promote_to_component(finalized_core, MagneticData(Materials.abstract.pure.iron))
...
slot = MagneticData(Materials.abstract.pure.copper, phase, 100, 0.1 * mm)
...
domain = Domain(
    ...
    Materials.abstract.environmental.atmosphere,
